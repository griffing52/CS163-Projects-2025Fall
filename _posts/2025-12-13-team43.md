...
<div style="text-align: center;">
  <img src="{{ '/assets/images/43/worst_IoUs.png' | relative_url }}"
       ...
       style="width: 800px; max-width: 100%;" />
  <p><em>
    5 images from the 'Universally Easy' category on top with the lowest loss--highest IoUs--and 5 images from the 'Universally Hard' category that includes images that collectively had some of the lowest performance independent of model.
  </em></p>
</div>
