...
<div style="text-align: center;">
  ...
  <p><em>
    Fig 2. Per-Category IoU distributions (Ridgeline Plot) for the SegFormer baseline. This visualization highlights the performance disparity described in the text: large, dominant classes (e.g., road, sky, car) exhibit sharp peaks near perfect IoU, indicating consistent reliability. In contrast, thin and safety-critical structures (e.g., pole, fence, traffic sign) show broad, flattened distributions, visually confirming the high variance and frequent failure modes associated with segmenting thin geometry.
  </em></p>
</div>
